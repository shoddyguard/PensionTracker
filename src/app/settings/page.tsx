...
export default async function SettingsPage() {
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-8 space-y-8">
      ...
      {isCredentialsUser && (
        <div>
          <h2 className="text-base font-semibold text-gray-900 dark:text-gray-50 mb-4">Change Password</h2>
          <ChangePasswordForm />
        </div>
      )}
      ...
      <div className="space-y-4">
        ...
        <div className="border border-red-200 dark:border-red-900 rounded-lg p-4 flex items-center justify-between gap-4">
          <div>
            <p className="text-sm font-medium text-gray-900 dark:text-gray-100">Clear all data</p>
