...
export function SnapshotForm({
  ...
  return (
    <form action={action} onSubmit={handleSubmit} className="space-y-8">
      ...
      {/* Fund values */}
      <div>
        <h2 className="text-base font-semibold text-gray-900 mb-3">Fund Values</h2>
                ...
                <tr key={fund.id}>
                  ...
                  <td className="px-4 py-3">
                    <input
                      ...
                      className="w-36 border border-gray-300 rounded-md px-2 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-gray-900"
                    />
                  </td>
                  <td className="px-4 py-3">
                    <div className="relative w-36">
                      ...
                      <input
                        ...
                        className="w-full pl-6 border border-gray-300 rounded-md px-2 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-gray-900"
                      />
                    </div>
                  </td>
                </tr>
        ...
        <p className="text-xs text-gray-500 mt-2">Leave blank for any fund not held in this snapshot.</p>
      </div>

      {/* Contributions */}
      <div>
        <h2 className="text-base font-semibold text-gray-900 mb-3">Contributions This Period</h2>
